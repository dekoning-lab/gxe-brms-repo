...
#SBATCH --job-name=v3s100
#SBATCH --array=1-300
#SBATCH --output=logs/v3_m4_s100_%A_%a.out
#SBATCH --error=logs/v3_m4_s100_%A_%a.err
...
echo "M4 v3 sensitivity: parenting=${PV}, sigma=1.00, imp=${IMP}"
Rscript scripts/52_fit_m4_v3_sensitivity.R ${PV} 1.00 ${IMP} ${IMP}
